...
const observer = new MutationObserver(function (mutationsList) {
    for (let mutation of mutationsList) {
        if (mutation.type === 'childList' && mutation.addedNodes.length > 0) {
            // Handle newly inserted nodes here
            // You can access the new nodes using mutation.addedNodes
            // For example, if you want to iterate through the newly added nodes:
            mutation.addedNodes.forEach(function (node) {
                // Do something with the newly added node (node)
            });
        }
    }
})
                        ...
                        return (function (t) {
                                ...
                                var y = (function (t) {
                                    function e(t, n) {
                                        ...
                                        return (
                                            ...
                                            observer.observe(r.domNode, { childList: true }),
                                            r.optimize(),
                                            r.enable(),
                                            r
                                        );
                            ...
                            function (t, e, n) {
                                ...
                                var u = {
                                    ...
                                    h = new f("font", "font-family", u);
                                (e.FontStyle = h), (e.FontClass = c);
                            },
                            function (t, e, n) {
                                "use strict";
                                Object.defineProperty(e, "__esModule", { value: !0 }),
                                    ...
                                    return (
                                        ...
                                        (function (t) {
                                            for (
                                                ...
                                                0 === t[o - 2][0] &&
                                                    (i = t[o - 2][1]).charCodeAt(i.length - 1) >=
                                                    55296 &&
                                                    i.charCodeAt(i.length - 1) <= 56319 &&
                                                    t[o - 1][0] === n &&
                                                    r(t[o - 1][1]) &&
                                                    1 === t[o][0] &&
                                                    r(t[o][1]) &&
                                            ...
                                            case 0:
                                                o + s > 1
                                                    ? (0 !== o &&
                                                        0 !== s &&
                                                        (0 !== (e = i(c, u)) &&
                                                            (r - o - s > 0 && 0 == t[r - o - s - 1][0]
                                                                ? (t[r - o - s - 1][1] += c.substring(0, e))
                                                                : (t.splice(0, 0, [0, c.substring(0, e)]),
                                                                    r++),
                                                                (c = c.substring(e)),
                                                                (u = u.substring(e))),
                                                            0 !== (e = l(c, u)) &&
                                                            ((t[r][1] =
                                                                c.substring(c.length - e) + t[r][1]),
                                                                (c = c.substring(0, c.length - e)),
                                                                (u = u.substring(0, u.length - e)))),
                                                        0 === o
                                                            ? t.splice(r - s, o + s, [1, c])
                                                            : 0 === s
                                                                ? t.splice(r - o, o + s, [n, u])
                                                                : t.splice(r - o - s, o + s, [n, u], [1, c]),
                                                        (r = r - o - s + (o ? 1 : 0) + (s ? 1 : 0) + 1))
                                                    : 0 !== r && 0 == t[r - 1][0]
