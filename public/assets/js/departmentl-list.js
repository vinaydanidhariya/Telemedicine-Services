...
$(function () {
      ...
      (e.length &&
        ((l = e.DataTable({
          ...
          columnDefs: [
            ...
            //     render: function (e, t, a, s) {
            //         var n = a.photo_url,
            //             l = a.department_name + " " + a.description,
            //             r = a.qualifications;
  ...
  $(".datatables-department-list tbody").on(
    "click",
    ".delete-record",
    function () {
      ...
      $.ajax({
        url: `/department/delete-department`,
        type: "post",
        data: {
          code: "778899",
        ...
        .then(function (response) {
          if (response.type === "success") {
            // Check response.type instead of response.data.type
            Swal.fire({
              icon: "success",
    ...
    $(".datatables-department-list tbody").on(
      ...
      function () {
        ...
        window.location.href = `/department/edit-department/${rowData.department_id}`;
      }
    );
});
